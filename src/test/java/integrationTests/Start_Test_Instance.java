...
import integrationTests.selenium.Create_TestDriver;
...
public class Start_Test_Instance {

	//Parallel processing achieved in testNG using ThreadLocal
	public static ThreadLocal<Create_TestDriver> test_instance = new ThreadLocal<Create_TestDriver>();
	...
	public void setUpClass(
		...
		Create_TestDriver testDriver = new Create_TestDriver(
				operating_system, 
				browser, 
				browser_version, 
				browser_headless, 
